...
public class Cuenta {
     ...
     * @param idCliente
     */
    public Cuenta(int numeroCuenta, String fechaApertura, String fechaTransaccion, float saldo, String estado, int idCliente) {
     ...
     * @param idCliente
     */
    public Cuenta(int id, int numeroCuenta, String fechaApertura, String fechaTransaccion, float saldo, String estado, int idCliente) {
        this.id = id;
        this.numeroCuenta = numeroCuenta;
        this.fechaApertura = fechaApertura;
        this.fechaTransaccion = fechaTransaccion;
