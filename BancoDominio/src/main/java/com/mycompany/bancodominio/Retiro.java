...
public class Retiro {
     ...
     */
    public Retiro(int folioOperacion, String contra, String estado, String fechaTransaccionLimite) {
     ...
     * @param fechaTransaccionLimite
     */
    public Retiro(int id, int folioOperacion, String contra, String estado, String fechaTransaccionLimite) {
        this.id = id;
        this.folioOperacion = folioOperacion;
        this.contra = contra;
        this.estado = estado;
