...
public class Cliente {
     ...
     * @param contra
     */
    public Cliente(String nombre, String apellidoPaterno, String apellidoMaterno, String fechaNacimiento, String usuario, String contra) {
        this.nombre = nombre;
     ...
     * @param contra
     */
    public Cliente(int id, String nombre, String apellidoPaterno, String apellidoMaterno, String fechaNacimiento, String usuario, String contra) {
        this.id = id;
        this.nombre = nombre;
        this.apellidoPaterno = apellidoPaterno;
        this.apellidoMaterno = apellidoMaterno;
